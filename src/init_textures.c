...
void	init_textures_east_west(t_info *info)
{
	...
	info->ray.texture[2].addr2 = \
		...
		&info->ray.texture[2].bits_per_pixel, &info->ray.texture[2].line_length, \
	...
	info->ray.texture[3].addr2 = \
		...
		&info->ray.texture[3].bits_per_pixel, &info->ray.texture[3].line_length, \
...
void	init_textures(t_info *info)
{
	...
	info->ray.texture[0].addr2 = \
		...
		&info->ray.texture[0].bits_per_pixel, &info->ray.texture[0].line_length, \
	...
	info->ray.texture[1].addr2 = \
		...
		&info->ray.texture[1].bits_per_pixel, &info->ray.texture[1].line_length, \
